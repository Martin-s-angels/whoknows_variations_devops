...
SEARCH_REQUESTS_NOT_FOUND = Prometheus::Client::Counter.new(:total_search_requests_not_found,
                                                            docstring: 'A of searches made')
...
SEACH_DURATION = Prometheus::Client::Histogram.new(:search_duration_secounds,
                                                   docstring: 'time spent looking into the db for matches')
